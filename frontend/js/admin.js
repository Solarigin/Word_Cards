    ...
    users.forEach(u => {
      ...
      tr.innerHTML = `
        ...
        <td class="px-4 py-2 space-x-2">
          <button data-id="${u.id}" class="px-3 py-1 rounded bg-indigo-600 text-white reset-btn">
            Reset
          </button>
          <button data-id="${u.id}" class="px-3 py-1 rounded bg-gray-200 text-gray-700 delete-btn">
            Delete
          </button>
        </td>`;
